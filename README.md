...
- **AI**: OpenRouter (meta-llama/llama-3.1-8b-instruct:free - free tier)
...
- `OPENROUTER_API_KEY`: Required for AI responses (get from [OpenRouter](https://openrouter.ai/keys))
